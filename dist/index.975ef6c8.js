...
var _fetchGalleryPhotos = require("./js/fetchGalleryPhotos");
const refs = {
...
async function loadPics(inputValue1, page1) {
    refs.loadMoreBtn.style.display = "none";
    if (inputValue1 === "") return;
    try {
        const pic = await (0, _fetchGalleryPhotos.fetchGalleryPhotos)(inputValue1, page1, perPage);
        const stats = pic.data.hits;
        const hitsLength = pic.data.hits.length;
        if (hitsLength < perPage && hitsLength > 0) {
            refs.loadMoreBtn.style.display = "none";
            endSearch();
        } else refs.loadMoreBtn.style.display = "block";
        if (stats.length === 0) noImagesFound();
        else renderGalleryMarkup(stats);
        return pic;
    } catch (error) {
        console.log(error);
    } finally{
...
function renderGalleryMarkup(stats) {
    stats.forEach(({ webformatURL , largeImageURL , tags , likes , views , comments , downloads ,  })=>{
  ...
  <div class="info">
    ...
    if (lightbox !== null) lightbox.refresh();
}
...
function totalHitsFound(totalHits) {
    if (totalHits !== 0) (0, _notiflixDefault.default).Notify.success(`Hooray! We found ${totalHits} images.`);
}
...
},{"notiflix":"5z0Oc","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","./js/fetchGalleryPhotos":"vR8te","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5z0Oc":[function(require,module,exports) {
var global = arguments[3];
...
},{}],"kaxSc":[function() {},{}],"vR8te":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fetchGalleryPhotos", ()=>fetchGalleryPhotos);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const BASE_URL = "https://pixabay.com";
async function fetchGalleryPhotos(name, page, perPage) {
    ...
    try {
        const response = await (0, _axiosDefault.default).get(`${BASE_URL}/api/?${params}`);
        return response;
    } catch (error) {
        return error;
    }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["1RB6v","8lqZg"], "8lqZg", "parcelRequiref81b")
